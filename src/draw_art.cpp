...
int main(int argc, char **argv)
{
   ...
   maurer.maurerRose(6, 71, PointAndColor(400, 400, Pixel{52, 235, 164}),
                     Pixel{235, 52, 213});
   maurer.maurerRose(5, 97, PointAndColor(0, 0, Pixel{245, 39, 12}),
                     Pixel{52, 158, 235});
   maurer.maurerRose(5, 97, PointAndColor(0, 800, Pixel{245, 39, 12}),
                     Pixel{52, 158, 235});
   maurer.maurerRose(5, 97, PointAndColor(800, 0, Pixel{245, 39, 12}),
                     Pixel{52, 158, 235});
   maurer.maurerRose(5, 97, PointAndColor(800, 800, Pixel{245, 39, 12}),
                     Pixel{52, 158, 235});
   ...
   eyeball.triCircle(PointAndColor(400, 400, Pixel{245, 171, 12}),
                     Pixel{12, 206, 245}, 1000, 300);
   eyeball.stylizedCircle(PointAndColor(400, 400, Pixel{1, 1, 1}),
                          Pixel{255, 230, 153}, 1000, 300);
   ...
   for (int i = 0; i < 800; i += 100)
   {
      ...
      {
         polka.triCircle(PointAndColor(i, j, colors[counter]),
                         colors[counter + 1], 360, 50);
         counter += 1;
      }
      counter = 0;
   }
   ...
   flag.triCircle(PointAndColor(400, 250, Pixel{245, 183, 69}),
                  Pixel{245, 183, 69}, 40, 150);
